...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        def prod1 = new Product(category:cat1,manufacturer:mfg1,name:'Prod 1', description:'Described',price:1.0,rating:'5',score:1,pic:'https://images.yourstory.com/2016/08/125-fall-in-love.png').save(failOnError:true)
        def user = new User(
                userName: 'jack_bubba',
                password: 'xyzxyzxyz',
