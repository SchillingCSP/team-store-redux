...
<html>
    ...
    <body>
        ...
        <div id="show-productReview" class="content scaffold-show" role="main">
            ...
            <f:display bean="productReview" />
            <g:form resource="${this.productReview}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.productReview}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
