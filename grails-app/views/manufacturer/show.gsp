...
<html>
    ...
    <body>
        ...
        <div id="show-manufacturer" class="content scaffold-show" role="main">
            ...
            <f:display bean="manufacturer" />
            <g:form resource="${this.manufacturer}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.manufacturer}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
