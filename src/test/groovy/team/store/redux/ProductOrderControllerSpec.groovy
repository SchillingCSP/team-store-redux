...
class ProductOrderControllerSpec extends Specification {
    ...
    void "Test the save action with an invalid instance"() {
        given:
        controller.productOrderService = Mock(ProductOrderService) {
            1 * save(_ as ProductOrder) >> { ProductOrder productOrder ->
                throw new ValidationException("Invalid instance", productOrder.errors)
            }
        }
    ...
    void "Test the show action with a valid id"() {
        ...
        model.productOrder instanceof ProductOrder
    }
    ...
    void "Test the update action with an invalid instance"() {
        ...
        request.contentType = FORM_CONTENT_TYPE
        request.method = 'PUT'
        controller.update(new ProductOrder())
